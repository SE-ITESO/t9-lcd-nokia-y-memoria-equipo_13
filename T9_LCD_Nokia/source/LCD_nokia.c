 ...
 *
 * Brief
 * 	ejecutable del modulo para inicializacion y manejo de la pantalla LCD nokia
...
void LCD_nokia_init(void) //CONFIGURAR GPIO
{
	...
	GPIO_PinInit(GPIOC, DATA_OR_CMD_PIN, &led_config);
	GPIO_PinInit(GPIOC, RESET_PIN, &led_config1);
